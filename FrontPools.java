 ...
 * @author garci
 */
public class FrontPools extends javax.swing.JFrame {

    /**
     * Creates new form FrontPools
     */
    public FrontPools() {
        initComponents();
        loadPoolToTable();
...
private double getPriceFromDatabase(String name, String category) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FRONT DESK SYSTEM POOLS");
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, 590, 250));
        ...
        jPanel1.add(txtsearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 150, 270, 28));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrontPools.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrontPools().setVisible(true);
            }
        });
    }
