 ...
 * @author garci
 */
public class FrontActivities extends javax.swing.JFrame {

    /**
     * Creates new form FrontActivities
     */
    public FrontActivities() {
        initComponents();
                loadActsToTable();
    }
...
private double getPriceFromDatabase(String name, String category) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FRONT DESK ACTIVITIES");
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 210, 560, 250));
        ...
        jPanel1.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 490, 101, 35));

        Bookings.setBackground(new java.awt.Color(0, 207, 102));
        ...
        jPanel1.add(Bookings, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 460, 150, 60));
        ...
        jPanel1.add(txtsearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 160, 270, 28));
        ...
        jPanel1.add(btnsearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 70, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Administrator\\Downloads\\31725 (1).jpg")); // NOI18N
...
// Load data from Prices table (for activities only)
loadPricesToDropdown("Activities", activitiesDropdown);

// Panel for user input
JPanel panel = new JPanel(new GridLayout(6, 2)); // Adjusted for fewer fields
...
if (result == JOptionPane.OK_OPTION) {
    ...
    try {
        ...
        // Save to database
        Connection connection = DatabaseConnection.getConnection();
        String sql = "INSERT INTO Billing (FullName, NumberOfPeople, Activity, Parking, Cottage, Total) VALUES (?, ?, ?, ?, ?, ?)";
        PreparedStatement preparedStatement = connection.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrontActivities.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrontActivities().setVisible(true);
            }
        });
    }
